...
def login():
	...
	if TUTUL in ['m']:
		...
		result()
	elif TUTUL in ['2','02']:os.system('xdg-openhttps://www.facebook.com/SHaYaNoHaRaMi007?mibextid=ZbWKwL  ')
	elif TUTUL in ['0']:
...
def Subscraption():
	...
	r1=requests.get("https://raw.githubusercontent.com/SHaYanxALyan/shayanxd/main/sk.txt").text
	if key1 in r1:
		os.system('clear')
		login()
	else:
